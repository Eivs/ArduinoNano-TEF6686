...
static const uint8_t INIT_DATA[] PROGMEM = {
    ...
    0x03, 0x1C, 0x00, 0x00, // Clear Required Initialization Control
    0x03, 0x14, 0x00, 0x01, // ùStartù brings the device into ùidle stateù
    ...
    0x05, 0x40, 0x05, 0x01, 0x00, 0x01,                         // APPL_Activate brings the device into ùactive stateù = radio standby
...
const char *const ptyLabels[] PROGMEM = {
    "None",
    "News",
    "Current Affairs",
    "Information",
...
typedef struct Quality
{
  ...
  String GetQualityTimeStampString()
  {
    return String(QualityTimeStamp / 10) + "ms";
  }

  String GetLevelString()
  {
    return String(Level / 10) + "dBuv";
  }

  String GetNoiseString()
  {
    return String(Noise / 10) + "%";
  }

  String GetWamString()
  {
    return String(Wam / 10) + "%";
  }

  String GetOffsetString()
  {
    return String(Offset / 10) + "kHz";
  }

  String GetBandwidthString()
  {
    return String(Bandwidth / 10) + "kHz";
  }

  String GetModulationString()
  {
    return String(Modulation / 10) + "%";
  }
