...
typedef struct Quality
{
  ...
  String GetQualityTimeStampString() { return String(QualityTimeStamp / 10) + "ms"; }
  String GetLevelString() { return String(Level / 10) + "dBuv"; }
  String GetNoiseString() { return String(Noise / 10) + "%"; }
  String GetWamString() { return String(Wam / 10) + "%"; }
  String GetOffsetString() { return String(Offset / 10) + "kHz"; }
  String GetBandwidthString() { return String(Bandwidth / 10) + "kHz";}
  String GetModulationString() { return String(Modulation / 10) + "%";}
